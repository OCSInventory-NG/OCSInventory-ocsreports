...
if ($ESC_POST['SELECT'] != ''){
	if ($ESC_POST['onglet'] == 'MACH')
	$nb_affect=active_mach($list_id,$ESC_POST['SELECT']);
	if ($ESC_POST['onglet'] == 'SERV_GROUP')
	$nb_affect=active_serv($list_id,$ESC_POST['SELECT'],$ESC_POST['rule_choise']);
...
if(($ESC_POST['CHOISE'] != '' and $ESC_POST['onglet'] == 'MACH') 
	or ($ESC_POST['onglet'] == 'SERV_GROUP' and $ESC_POST['rule_choise'] != '')){
