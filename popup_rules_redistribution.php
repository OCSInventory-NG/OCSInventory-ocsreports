...
function check() {
	var msg = "";
		...
		msg += "Choisissez une r�gle d'affectation";
	}
	if (msg == "") Reporter();
	else	{
		alert(msg);
...
<table align='center' width='95%' border='0' cellspacing=20 bgcolor='#C7D9F5' style='border: solid thin; border-color:#A1B1F9'>
	<tr><td colspan=20 align='center'><font color=red>".$l->g(667)." ".$protectedGet['paq_name']."</font></td></tr>
...
";
echo "<input type='hidden' name='GROUP_ID' value='".$protectedGet['GROUP_ID']."'>";
echo "<input type='hidden' name='TIMESTAMP' value='".$protectedGet['timestamp']."'>";
echo "</form>";
?>
