...
foreach ($count_id as $lbl => $count_value) {
    ...
    switch ($lbl) {
        case "hostname_serial": echo $l->g(193);
            break;
        case "hostname_macaddress": echo $l->g(194);
            break;
        case "macaddress_serial": echo $l->g(195);
            break;
        case "hostname": echo $l->g(196);
            break;
        case "ssn": echo $l->g(197);
            break;
        case "macaddress": echo $l->g(198);
            break;
    }
    echo ":&nbsp;<b>";
    if ($count_value != 0) {
...
if ($protectedPost['detail'] != '') {
    ...
    if (($protectedPost['detail'] == "macaddress" || $protectedPost['detail'] == "macaddress_serial") && count($list_info) > 0) {
