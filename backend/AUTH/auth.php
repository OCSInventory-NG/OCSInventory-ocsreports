 ...
 */
 ...
 if ($affich_method == 'HTML' and isset($ESC_POST['VALID']) and trim($ESC_POST['LOGIN']) != ""){
 	$login=$ESC_POST['LOGIN'];
 	$mdp=$ESC_POST['PASSWD']; 	
...
if($login_successful == "OK" and isset($login_successful)) {
	...
	if ($affich_method == 'HTML'){
		...
		echo "<b>".$l->g(24).":</b></td><td><input type='text' name='LOGIN' id ='LOGIN' value='".(isset($ESC_POST['LOGIN']) ? $ESC_POST['LOGIN']: '')."'></td></tr><tr><td align=center>";
		echo "<b>".$l->g(217).":</b></td><td><input type='password' name='PASSWD' id ='PASSWD' value='".(isset($ESC_POST['PASSWD']) ? $ESC_POST['PASSWD']: '')."'></td></tr>";
