<?php
require 'require/assets/AssetsCategory.php';
require 'require/softwares/SoftwareCategory.php';
  $assets = new AssetsCategory();
  $soft = new SoftwareCategory();

  $assets->get_assets();
  $soft->get_table_html_soft();
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, sans-serif;font-size:10px;font-weight:300;line-height:24px;text-align:left;color:#616161;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
              <tr>
                <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                  <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:300;line-height:24px;text-align:right;color:#616161;">
                    Notification
                  </div>
                </td>
              </tr>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:250px;">
                                <a href="https://www.ocsinventory-ng.org" target="_blank">
                                  <img height="auto" src="https://i.imgur.com/1sDetbn.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="250"/>
                                </a>
                              </td>
                            </tr>
                          </tbody>
