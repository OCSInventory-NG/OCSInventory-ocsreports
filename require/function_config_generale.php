...
function update_default_value($POST) {
    ...
    $array_simple_ivalue = array('INVENTORY_DIFF', 'INVENTORY_TRANSACTION', 'INVENTORY_WRITE_DIFF',
        ...
        'SECURITY_AUTHENTICATION_NB_ATTEMPT', 'SECURITY_AUTHENTICATION_TIME_BLOCK');
...
function pagesSecurity(){
    ...
    ligne('SECURITY_AUTHENTICATION_BLOCK_IP', $l->g(272) . " (" . $l->g(1320) . ")", 'radio', array(1 => 'ON', 0 => 'OFF', 'VALUE' => $values['ivalue']['SECURITY_AUTHENTICATION_BLOCK_IP']));
    ligne('SECURITY_AUTHENTICATION_NB_ATTEMPT', $l->g(272) . " (" . $l->g(1320) . ")", 'input', array('VALUE' => $values['ivalue']['SECURITY_AUTHENTICATION_NB_ATTEMPT'], 'SIZE' => 1, 'MAXLENGTH' => 3, 'JAVASCRIPT' => $numeric), '', '', $sup1);
    ligne('SECURITY_AUTHENTICATION_TIME_BLOCK', $l->g(272) . " (" . $l->g(1320) . ")", 'input', array('END' => $l->g(511), 'VALUE' => $values['ivalue']['SECURITY_AUTHENTICATION_TIME_BLOCK'], 'SIZE' => 1, 'JAVASCRIPT' => $numeric), '', '', $sup1);
}
