...
ALTER TABLE groups change REVALIDATE_FROM REVALIDATE_FROM INT default 0 not NULL; 	 
ALTER TABLE groups change CREATE_TIME CREATE_TIME INT default 0 not NULL;
...
ALTER TABLE networks ADD COLUMN VIRTUALDEV BOOL DEFAULT FALSE;
...
ALTER TABLE drives ADD COLUMN CREATEDATE TIMESTAMP;
...
ALTER TABLE hardware ADD COLUMN IPSRC VARCHAR(15) default NULL; 
