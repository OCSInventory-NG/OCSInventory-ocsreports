...
INSERT INTO downloadwk_fields (TAB,FIELD,TYPE,LBL,MUST_COMPLETED,VALUE,DEFAULT_FIELD,RESTRICTED,LINK_STATUS,ID) values (2,'INFO_PACK',0,636,1,'',1,0,0,3);
...
CREATE TABLE downloadwk_pack (
  ...
  field_1 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_2 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_3 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_4 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_5 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_6 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_7 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_8 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_9 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  field_10 varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (ID)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
